...
import utils.config.ConfigUser;
...
public class ObjectLoader extends Thread implements ConfigUser {
	...
	public void removeListner(ObjectLoaderListener oli) { _oli.remove(oli); }
	public void addListner(ObjectLoaderListener tci) {_oli.add(tci); }	
	...
	private GeoObject parseObject(InputStream is)
